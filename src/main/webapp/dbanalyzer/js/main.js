...
app.controller("analyzerCtrl", [
			    	...
			    	$http({
						...
						headers : {
							...
							angular.forEach($scope.counterpartyData, function(value){
								console.log(parseFloat(value[6]));
								$scope.counterpartyRP += parseFloat(value[5]);
								$scope.counterpartyEP += parseFloat(value[6]);
							});
					}, function failfunction(response) {	
					});
		    	}
	...
	//						angular.forEach($scope.buyPrices, function(value){
...
var dataSells = [
	  {
          ...
          },
          {
          	...
          	"population": 4467
							...
							visPieChart(dataBuys,"svgCounterparty1");
							visPieChart(dataSells,"svgCounterparty2");
							console.log(data);
			    	...
			    	$http({
						...
						headers : {
							...
							if ($scope.priceinfo[1] >= 0){
								...
								angular.element("#priceColor").css("color","green")
							} else {
								$scope.price = "negative";
								angular.element("#priceColor").css("color","red")
							}
